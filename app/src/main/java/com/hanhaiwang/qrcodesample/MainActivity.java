package com.hanhaiwang.qrcodesample;
...
import com.hanhaiwang.zxing.qrcode.activity.CaptureActivity;
import com.hanhaiwang.zxing.qrcode.encoding.EncodingHandler;
import com.hanhaiwang.zxing.qrcode.util.Constant;
import com.hanhaiwang.zxing.qrcode.util.QrCodeGenerator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void generateQrCode() {
        ...
        //第一种写法
        try {
            Bitmap bitmap = EncodingHandler.createQRCode(etContent.getText().toString(), imgQrcode.getWidth());
